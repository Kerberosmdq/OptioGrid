...
import { Plus, Save, ArrowLeft, ExternalLink, Loader2, Download, X, Share2 } from 'lucide-react';
                                ...
                                {!extractedData ? (
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex gap-6">
                                            <div className="w-32 h-32 bg-slate-100 rounded-xl flex-shrink-0 overflow-hidden border border-slate-200 dark:bg-slate-700 dark:border-slate-600">
